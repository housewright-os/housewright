...
## Never paste your configs anywhere public

Your `config/*.json` files and interview profile contain your family's
dietary and allergy information, kids' age bands, money structure, and
rhythm. They are gitignored here for a reason. When filing an issue or
asking for help anywhere public, share the error and the example configs,
never your real ones; redact anything household-specific first.
