...
#!/bin/bash
cd "$ROOT"
"$PY" scripts/engine.py --refresh >/dev/null 2>&1 || "$PY" scripts/engine.py >/dev/null 2>&1
...
#!/bin/bash
cd "$ROOT"
"$PY" scripts/engine.py --refresh >/dev/null 2>&1 || true
"$PY" scripts/weekly.py >/dev/null 2>&1
...
#!/bin/bash
cd "$ROOT"
"$PY" scripts/engine.py >/dev/null 2>&1 || true
